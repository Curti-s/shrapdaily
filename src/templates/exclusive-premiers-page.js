...
const ExclusivePremiersPage = ({ data }) => {
...
ExclusivePremiersPage.propTypes = {
  data: PropTypes.object.isRequired
};

export const exclusivePremiersPageQuery = graphql`
  query ExclusivePremiersPage($id: String!) {
    ...
    allMarkdownRemark(sort: {fields: frontmatter___date, order: DESC}, filter: { frontmatter:{ templateKey:{ eq:"exclusive-premiers" } } }) {
    edges {
      node {
        fields { slug }
        frontmatter {
...
export default ExclusivePremiersPage;
